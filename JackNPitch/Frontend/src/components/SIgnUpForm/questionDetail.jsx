      ...
      <Container maxWidth="xs">
        ...
        <Paper className={classes.paper} style={stt}>
          <Typography variant="h3" align="center">
            Later on , you will be given 9 questions , please answer them correctly , on the basis of which we will detect your chances of you being infected by covid19
          </Typography>
          <br />
          <br />
          <form>
