...
export default function QuestionDetail2(props) {
  function Continue(e) {
    e.preventDefault();
    props.nextStep();
  }
      ...
      <Container maxWidth="xs">
        ...
        <Paper className={classes.paper} style={stt}>
          <Typography variant="h5" align="center">
            Question 2. Have you or someone in your family travelled within
            India in public transport and came in close contact with someone
            with cough, cold, fever and shortness of breath in the last 14 days?
          </Typography>
          <br />
          <br />
          <form>
            <RadioGroup onChange={handleChange("q2")} vertical>
