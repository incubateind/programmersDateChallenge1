...
export default function QuestionDetail9(props) {
  function Continue(e) {
    e.preventDefault();
    props.nextStep();
  }
      ...
      <Container maxWidth="xs">
        ...
        <Paper className={classes.paper} style={stt}>
          <Typography variant="h4" align="center">
            Question 9. Have you or someone in your family come in close contact
            with a confirmed COVID-19 patient in the last 14 days?
          </Typography>
          <br />
          <br />
          <form>
            <RadioGroup onChange={handleChange("q9")} vertical>
