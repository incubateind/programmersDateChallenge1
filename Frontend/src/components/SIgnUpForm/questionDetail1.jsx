...
export default function QuestionDetail1(props) {
  function Continue(e) {
    e.preventDefault();
    props.nextStep();
  }
      ...
      <Container maxWidth="xs">
        ...
        <Paper className={classes.paper} style={stt}>
          <Typography variant="h4" align="center">
            Question 1. Do you or someone in your family visited any of the
            below countries in the last 14 days?
          </Typography>
          <br />
          <br />
          <form>
            <RadioGroup onChange={handleChange("q1")} vertical>
